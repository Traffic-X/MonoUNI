...
class Denorm(object):
    def __init__(self, denorm_file):
        ...
        self.c2g_trans = np.vstack([ground_x_axis, ground_y_axis, ground_z_axis]) #(3, 3)
        self.g2c_trans = np.linalg.inv(self.c2g_trans)

    def ground_center2object_center(self,camera_pos,h):
